...
class DatabaseHelper{
  static final _databaseName = "My_Database1.db";
  ...
  Future<List<ModelClass>> selectData(int id) async {
    final Database db = await _initDatabase();
    List<Map<String, Object?>> log = await db.rawQuery("SELECT * FROM STUDENT WHERE id = '$id'");
    return log.map((e) => ModelClass.fromMap(e)).toList();
