...
class EditingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.read<StudentCubit>().setData(index, nameController, emailController, dobController, courseController, admController, mobileController, passController);
    return Scaffold(
        body: Center(
